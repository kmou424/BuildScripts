...
make -j32 O=out ARCH=arm64 CC=clang CLANG_TRIPLE=aarch64-linux-gnu- CROSS_COMPILE=aarch64-linux-android- > build_full.log 2>&1 && cp out/arch/arm64/boot/*dtb $HOME/work/boot/. && cd $HOME/work && ./g upload boot/*
