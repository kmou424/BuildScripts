...
cp build.log $HOME/work/log/$DATE/$TIME/kernel_build.log
cp build_full.log $HOME/work/log/$DATE/$TIME/kernel_build_full.log

echo 'Your logs have been stored in ~/work/log/'$DATE'/'$TIME' directory'
echo 'Be careful: These are kernel build log,you should check kernel_* files'
